...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, FIELD_COMMANDER, INTELLIGENCE_OFFICER, PILOT_OFFICER, TANK_CREWMAN, WALKER_PILOT, CORPORATE_LIAISON, SYNTHETIC))
...
CHIEF_MEDICAL_OFFICER, SYNTHETIC, COMMAND_MASTER_AT_ARMS, MASTER_AT_ARMS, TANK_CREWMAN, WALKER_PILOT, CORPORATE_LIAISON, SHIP_ENGINEER, CARGO_TECHNICIAN, \
