...
/obj/machinery/vending/attachments
	...
	products = list(
						...
						/obj/item/attachable/angledgrip = 3,
						/obj/item/attachable/bipod = 1,
						/obj/item/attachable/burstfire_assembly = 1,
						/obj/item/attachable/gyro = 1,
						/obj/item/attachable/lasersight = 3,
						/obj/item/attachable/verticalgrip = 3,

						/obj/item/attachable/stock/smg = 2,
						/obj/item/attachable/stock/revolver = 2,
						/obj/item/attachable/stock/shotgun = 2,
						/obj/item/attachable/stock/rifle = 2 ,
						/obj/item/attachable/stock/tactical = 2,
