...
/proc/get_sfx(S)
	if(istext(S))
		switch(S)
			...
			if("male_pain")
				S = pick('sound/voice/human_male_pain_1.ogg','sound/voice/human_male_pain_2.ogg','sound/voice/human_male_pain_3.ogg','sound/voice/human_male_pain_4.ogg', 'sound/voice/human_male_pain_5.ogg','sound/voice/human_male_scream_6.ogg', 'sound/voice/human_male_pain_7.ogg', 'sound/voice/human_male_pain_8.ogg')
			if("male_fragout")
